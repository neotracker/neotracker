...
export class Block extends BlockchainModel<number> {
  ...
  public readonly validator_address_id!: string;
  ...
  public readonly previous_block_id!: number;
  public readonly previous_block_hash!: string;
  public readonly next_block_id!: number;
  public readonly next_block_hash!: string;
