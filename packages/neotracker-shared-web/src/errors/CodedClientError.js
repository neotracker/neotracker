...
export default class CodedClientError extends ClientError {
  ...
  static PRIVATE_KEY_WIF_UNKNOWN_CRYPTO_ERROR = 'PRIVATE_KEY_WIF_UNKNOWN_CRYPTO_ERROR';
  static PRIVATE_KEY_WIF_VERIFICATION_ERROR = 'PRIVATE_KEY_WIF_VERIFICATION_ERROR';
  ...
  static BASE58_CHECK_DECODE_INVALID_FORMAT = 'BASE58_CHECK_DECODE_INVALID_FORMAT';
  static BASE58_CHECK_DECODE_UNKNOWN_CRYPTO_ERROR = 'BASE58_CHECK_DECODE_UNKNOWN_CRYPTO_ERROR';
  static BASE58_CHECK_DECODE_VERIFICATION_ERROR = 'BASE58_CHECK_DECODE_VERIFICATION_ERROR';
  static WIF_ENCODE_ERROR = 'WIF_ENCODE_ERROR';
  static TRANSACTION_HASH_UNKNOWN_ERROR = 'TRANSACTION_HASH_UNKNOWN_ERROR';
  static TRANSFER_TRANSACTION_UNKNOWN_ERROR = 'TRANSFER_TRANSACTION_UNKNOWN_ERROR';
  static CLAIM_TRANSACTION_UNKNOWN_ERROR = 'CLAIM_TRANSACTION_UNKNOWN_ERROR';
  static DECRYPT_KEYSTORE_UNSUPPORTED_ALGO = 'DECRYPT_KEYSTORE_UNSUPPORTED_ALGO';
  static DECRYPT_KEYSTORE_UNSUPPORTED_PBKDF2_PARAMETERS = 'DECRYPT_KEYSTORE_UNSUPPORTED_PBKDF2_PARAMETERS';
  static DECRYPT_KEYSTORE_DERIVED_KEY_ERROR = 'DECRYPT_KEYSTORE_DERIVED_KEY_ERROR';
  static DECRYPT_KEYSTORE_UNKNOWN_CRYPTO_ERROR = 'DECRYPT_KEYSTORE_UNKNOWN_CRYPTO_ERROR';
  static DECRYPT_KEYSTORE_DECIPHER_ERROR = 'DECRYPT_KEYSTORE_DECIPHER_ERROR';
  static DECRYPT_KEYSTORE_WRONG_PASSPHRASE = 'DECRYPT_KEYSTORE_WRONG_PASSPHRASE';
  ...
  static EXTRACT_NEO_WEB_APP_INVALID_FORMAT = 'EXTRACT_NEO_WEB_APP_INVALID_FORMAT';
  static EXTRACT_NEO_WEB_APP_UNKNOWN_ERROR = 'EXTRACT_NEO_WEB_APP_UNKNOWN_ERROR';
  static EXTRACT_PRIVATE_KEYS_NEO_WEB_APP_UNKNOWN_ERROR = 'EXTRACT_PRIVATE_KEYS_NEO_WEB_APP_UNKNOWN_ERROR';
  static EXTRACT_PRIVATE_KEYS_NEO_WEB_APP_WRONG_PASSPHRASE = 'EXTRACT_PRIVATE_KEYS_NEO_WEB_APP_WRONG_PASSPHRASE';
  ...
  static CREATE_PAPER_WALLET_WINDOW_OPEN_ERROR = 'CREATE_PAPER_WALLET_WINDOW_OPEN_ERROR';
