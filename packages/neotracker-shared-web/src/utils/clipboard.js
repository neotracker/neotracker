...
const isSupported = (userAgent: UserAgent) => {
  ...
  return (
    ((document: $FlowFixMe).queryCommandSupported instanceof Function &&
      (document: $FlowFixMe).queryCommandSupported('copy') &&
...
const copy = (data: string, userAgent: UserAgent): Promise<void> => {
