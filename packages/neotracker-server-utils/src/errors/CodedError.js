...
export default class CodedError extends ClientError {
  ...
  static INVALID_CLIENT_COLLECTOR_FIELDS_NULL =
    'INVALID_CLIENT_COLLECTOR_FIELDS_NULL';
  static INVALID_CLIENT_COLLECTOR_FIELDS_OBJECT =
    'INVALID_CLIENT_COLLECTOR_FIELDS_OBJECT';
